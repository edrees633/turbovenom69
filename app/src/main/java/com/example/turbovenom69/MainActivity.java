...
public class MainActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Intent i = new Intent(MainActivity.this, AllPartActivity.class);
                            startActivity(i);
    ...
    public void gotoAddPart(View view) {
        Intent i = new Intent(this, AddPartActivity.class);
        startActivity(i);
    }

    public void gotoAllParts(View view) {
        Intent i = new Intent(this, AllPartActivity.class);
        startActivity(i);
    }
